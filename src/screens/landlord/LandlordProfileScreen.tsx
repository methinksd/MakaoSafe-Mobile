...
export default function LandlordProfileScreen() {
  ...
  // Landlord accent: amber/secondary instead of primary purple
    ...
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      <View style={styles.hero}>
        ...
        <View style={[styles.roleBadge, { backgroundColor: Colors.warningLight }]}>
          <Ionicons name="key-outline" size={13} color={accentColor} />
          <Text style={[styles.roleText, { color: accentColor }]}>Property Owner</Text>
        </View>
        <TouchableOpacity style={[styles.editBtn, { borderColor: accentColor }]} onPress={openEdit}>
