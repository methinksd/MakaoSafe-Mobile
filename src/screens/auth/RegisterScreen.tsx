...
export default function RegisterScreen() {
  ...
  const handleRegister = async () => {
    ...
    try {
      ...
      Telemetry.registerSuccess(role);
      Toast.show({
        type: 'success',
      ...
      const msg =
        ...
        (statusCode === 409 ? 'An account with this email or phone already exists' : 'Registration failed. Try again.');
      Telemetry.registerFailure(role, msg, statusCode);
