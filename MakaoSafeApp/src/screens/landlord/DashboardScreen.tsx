...
import { Card, LoadingSpinner, SectionHeader, StatusBadge } from '../../components/UI';
...
export default function LandlordDashboardScreen() {
  ...
  const stats = [
    { label: 'Listings', value: properties.length, icon: 'home', color: Colors.primary },
    { label: 'Bookings', value: bookings.length, icon: 'calendar', color: Colors.info },
